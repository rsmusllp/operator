...
requirements = kivy,plyer,smoke-zephyr,openssl,geojson,sleekxmpp
...
presplash.filename = %(source.dir)s/data/images/splash/logo.png

# (str) Icon of the application
icon.filename = %(source.dir)s/data/images/splash/logo.png
